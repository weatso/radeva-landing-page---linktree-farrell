...
const SERVICES = [
  ...
  },
  {
    ...
    description: "Spesialisasi kami dalam merancang acara di berbagai skala, dari intimate hingga perayaan besar. Fokus pada detail personal, atmosfer memukau, dan pengalaman tamu yang tak terlupakan.",
    link: "#"
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-gold-500/20">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className="group relative border-b md:border-b-0 md:border-r border-gold-500/20 p-8 md:p-12 transition-colors duration-500 hover:bg-radeva-800/50 cursor-pointer last:border-r-0 last:border-b-0"
            >
              {/* Number */}
